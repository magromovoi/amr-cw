...
def get_loaders():
    test_dataset = ExampleDataset(root='example_data/', test=True)
...
def plot_t_sne(graph_embeddings, predictions):
    ...
    colors = ListedColormap(["blue", "orange", "green", "red", "purple", "brown", "pink", "gray", "olive", "cyan"])
    ...
    plt.title("Graph t-SNE for test document graphs belonging to various classes of the ten newsgroups dataset.", fontsize=15)
