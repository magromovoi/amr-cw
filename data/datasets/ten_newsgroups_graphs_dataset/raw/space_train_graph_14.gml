graph [
  ...
  node [
    id 206
    label "agg1-of ( activity-06 ) :mod ( galaxy ) ) ) ) ) ) :op3 ( organization_4 :name ( name_6 :op1 "
  ]
  node [
    id 207
    label "nucleus"
  ...
  node [
    id 873
    label " ) ) :arg2 ( unit :mod ( solar_1 ) :mod ( small-molecule_5 :name ( name_2 :op1 "
  ]
  node [
    id 874
    label "signal-07"
